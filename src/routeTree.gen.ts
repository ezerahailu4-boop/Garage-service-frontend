...
import { Route as VehicleStatusIndexRouteImport } from './routes/vehicle-status/index'
...
const VehicleStatusIndexRoute = VehicleStatusIndexRouteImport.update({
  id: '/vehicle-status/',
  path: '/vehicle-status/',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/vehicle-status/': typeof VehicleStatusIndexRoute
...
export interface RootRouteChildren {
  ...
  VehicleStatusIndexRoute: typeof VehicleStatusIndexRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/vehicle-status/': {
      ...
      preLoaderRoute: typeof VehicleStatusIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/inspector/': {
      id: '/inspector/'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  VehicleStatusIndexRoute: VehicleStatusIndexRoute,
}
